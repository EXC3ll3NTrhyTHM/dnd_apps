...
export default function Landing() {
  const [authUrl, setAuthUrl] = useState('/api/auth/login');

  useEffect(() => {
    fetch('/api/auth/discord-url')
      .then(res => res.json())
      .then(data => setAuthUrl(data.url))
      .catch(() => {}); // keep /api/auth/login fallback
  }, []);
    ...
    <div className="landing">
      ...
      <div className="landing-content">
        ...
        <div className="landing-divider">
          <span className="divider-ornament">⚜️</span>
        </div>
        <p className="landing-flavor">
          Browse the shop, check your quests, order a drink from Tam...
          <br />
          All from the palm of your hand.
        </p>
        <a className="btn btn-discord" href={authUrl}>
          <svg className="discord-icon" viewBox="0 0 24 24" width="20" height="20">
