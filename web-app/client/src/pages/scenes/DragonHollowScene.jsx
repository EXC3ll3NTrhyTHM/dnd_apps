/**
 * DragonHollowScene - The tavern at the heart of Okhan
 */
...
export default function DragonHollowScene({
  location,
  isAdmin,
  onNpcClick,
  onGatheringClick,
  ...
  return (
    <div
      className={`location-scene dragon-hollow-scene ${editor.editMode ? 'edit-active' : ''}`}
      ref={editor.sceneRef}
    >
      {/* Background */}
      <div
      ...
      {/* Fireflies (tavern warmth) */}
      <div className="scene-fireflies">
        {Array.from({ length: 10 }, (_, i) => (
          <div key={i} className={`firefly ff${i + 1}`} />
        ))}
      </div>
